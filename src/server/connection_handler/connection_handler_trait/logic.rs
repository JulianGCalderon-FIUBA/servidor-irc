...
pub trait ConnectionHandlerLogic<C: Connection> {
    ...
    fn user_logic(&mut self, arguments: CommandArgs) -> io::Result<bool> {
        Ok(true)
    }
    fn oper_logic(&mut self, arguments: CommandArgs) -> io::Result<bool> {
        Ok(true)
    }
    fn privmsg_logic(&mut self, arguments: CommandArgs) -> io::Result<bool> {
        Ok(true)
    }
    ...
    fn names_logic(&mut self, arguments: CommandArgs) -> io::Result<bool> {
        Ok(true)
    }
    fn list_logic(&mut self, arguments: CommandArgs) -> io::Result<bool> {
        Ok(true)
    }
    fn who_logic(&mut self, arguments: CommandArgs) -> io::Result<bool> {
        Ok(true)
    }
    fn whois_logic(&mut self, arguments: CommandArgs) -> io::Result<bool> {
        Ok(true)
    }
