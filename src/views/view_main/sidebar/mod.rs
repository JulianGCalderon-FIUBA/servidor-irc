...
use gtk::{glib::Sender, prelude::*, Box, Entry, Label, Orientation, ScrolledWindow};
use gtk4 as gtk;
...
impl MainView {
    pub fn create_sidebar(&mut self) -> Box {
        ...
        //Channels box
        let scrolled_window_channels: ScrolledWindow =
            create_scrollwindow_sidebar(&self.channels_box);
        ...
        //Clients box
        let scrolled_window_clients: ScrolledWindow =
            create_scrollwindow_sidebar(&self.clients_box);
